...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '189efe246f004c1f87e23ab99427889d,docs:13f4db9a49134e21b2b34d284ca1bef0',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Astrum', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Astrum / Dawn', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.astrumspace.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Astrum, 博客, Dawn, Astrum Space', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'support@astrumspace.top', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/AstrumSpace2024', // 你的twitter个人主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.imesong.com/file/783b8bdda93087b24ceac.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Astrum Space', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Astrum', // 站点描述，被notion中的页面描述覆盖
